...
Please use the [issue template](https://github.com/jonasbn/macaliaser/blob/master/.github/ISSUE_TEMPLATE.md).
...
Please use the [PR template](https://github.com/jonasbn/macliaser/blob/master/.github/PULL_REQUEST_TEMPLATE.md).
...
Branching is highly recommended. This repository primarily works from master so this is recommended.

# Versioning

This application/script uses [Semantic Versioning](https://semver.org/).
